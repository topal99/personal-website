function submitForm(event) {
    ...
    if (isConfirmed) {
      ...
      link.href = `mailto:boroajak@gmail.com?subject=${encodeURIComponent(selectSubject)}&body=Hello, my name is ${encodeURIComponent(inputName)}.%0D%0A%0D%0APhone Number: ${encodeURIComponent(inputPhone)}%0D%0A%0D%0AMessage:%0D%0A${encodeURIComponent(inputMessage)}`;
      link.click();
